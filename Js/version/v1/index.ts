export type IAlignmentResult = {
    singleByte_max: number;
    doubleByte_max: number;
    results: string[][]
}
export type IAlignmentParams = {
...
function alignmentsV1(strs: IAlignmentParams['strs']): IAlignmentResult
function alignmentsV1(params: IAlignmentParams): IAlignmentResult
function alignmentsV1(params: any): IAlignmentResult {
